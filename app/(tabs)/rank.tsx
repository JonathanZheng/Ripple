...
export default function LeaderboardScreen() {
  ...
  // Refresh when navigating to this tab from another tab
  useFocusEffect(useCallback(() => { fetchLeaderboard(); }, [fetchLeaderboard]));

  // Refresh when tapping the rank tab button while already on it
  const navigation = useNavigation();
  useEffect(() => {
    return navigation.addListener('tabPress' as any, () => { fetchLeaderboard(); });
  }, [navigation, fetchLeaderboard]);
